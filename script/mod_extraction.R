  ...
  tagList(
    ...
    mainPanel(
      conditionalPanel(
        ...
        condition = "input.type=='SNP'",
        ns = ns,
        withSpinner(DT::dataTableOutput(ns("snp_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
      ...
      conditionalPanel(
        ...
        condition = "input.type=='Gene'",
        ns = ns,
        withSpinner(DT::dataTableOutput(ns("gene_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
        br(),
      ...
      conditionalPanel(
        ...
        condition = "input.type=='Accession'",
        ns = ns,
        withSpinner(plotOutput(ns("accession_dis")), image = "img/custom.gif", image.width = 256, image.height = 256),
        br(),
        ...
        br(),
        h2("Accession Info:"),
        withSpinner(DT::dataTableOutput(ns("aceession_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
        br(),
