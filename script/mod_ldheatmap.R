...
mod_ldheatmap_ui <- function(id) {
  ...
  tagList(
    ...
    mainPanel(
      h2("LDheatmap:"),
      withSpinner(plotOutput(ns("ldheatmap")), image = "img/custom.gif",image.width = 256, image.height = 256),
      ...
      br(),
      h2("SNP Informations:"),
      withSpinner(DT::dataTableOutput(ns("ld_snp_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
