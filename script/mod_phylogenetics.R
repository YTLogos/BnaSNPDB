mod_phylogenetics_ui <- function(id) {
  ...
  tagList(
    ...
    mainPanel(
      ...
      withSpinner(plotOutput(ns("tree")), image = "img/custom.gif", image.width = 256, image.height = 256),
      ...
      br(),
      h2("SNP Informations:"),
      withSpinner(DT::dataTableOutput(ns("tree_snp_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
      ...
      h5("minor: minorr allele, is the less common allele with lower frequency."),
