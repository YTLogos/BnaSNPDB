...
mod_snpdistribution_ui <- function(id) {
  ...
  tagList(
    ...
    mainPanel(
      h2("SNPdistribution:"),
      withSpinner(plotOutput(ns("snp_dis")), image = "img/custom.gif", image.width = 256, image.height = 256),
      ...
      br(),
      h2("SNP Informations:"),
      withSpinner(DT::dataTableOutput(ns("dis_snp_info")), image = "img/custom.gif", image.width = 256, image.height = 256),
